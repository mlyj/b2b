        ...
        <div>
          <div style="background: var(--bg-light); padding: 2rem; border-radius: 0.5rem;">
            ...
            <ul style="list-style: none;">
              ...
              <li style="padding: 0.5rem 0; border-bottom: 1px solid var(--border-color);">
                <strong>Employees:</strong> 20+
              </li>
              <li style="padding: 0.5rem 0; border-bottom: 1px solid var(--border-color);">
                <strong>Countries Served:</strong> 20+
              </li>
              <li style="padding: 0.5rem 0; border-bottom: 1px solid var(--border-color);">
                <strong>Annual Production:</strong> 8,000+ units
              </li>
      ...
      <div style="max-width: 800px; margin: 0 auto;">
        <div style="border-left: 3px solid var(--primary-color); padding-left: 2rem;">
          <div style="margin-bottom: 2rem; position: relative;">
            ...
            <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">2010 - Foundation</h3>
            <p style="color: var(--text-light);">Company established with a vision to provide quality industrial products.</p>
          </div>
          <div style="margin-bottom: 2rem; position: relative;">
            <div style="position: absolute; left: -2.5rem; width: 1.5rem; height: 1.5rem; border-radius: 50%; background: var(--primary-color);"></div>
            <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">2026 - International Expansion</h3>
            <p style="color: var(--text-light);">Began exporting products to international markets.</p>
          </div>
          <div style="margin-bottom: 2rem; position: relative;">
            <div style="position: absolute; left: -2.5rem; width: 1.5rem; height: 1.5rem; border-radius: 50%; background: var(--primary-color);"></div>
            <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">2026 - ISO Certification</h3>
            <p style="color: var(--text-light);">Achieved ISO 9001 certification for quality management.</p>
          </div>
          <div style="margin-bottom: 2rem; position: relative;">
            <div style="position: absolute; left: -2.5rem; width: 1.5rem; height: 1.5rem; border-radius: 50%; background: var(--primary-color);"></div>
            <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">2026 - Innovation Center</h3>
            <p style="color: var(--text-light);">Opened state-of-the-art research and development center.</p>
          </div>
          <div style="position: relative;">
            <div style="position: absolute; left: -2.5rem; width: 1.5rem; height: 1.5rem; border-radius: 50%; background: var(--primary-color);"></div>
            <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">2026 - Global Leader</h3>
            <p style="color: var(--text-light);">Recognized as a global leader in the industry, serving 20+ countries.</p>
          </div>
        </div>
      </div>
    </section>
